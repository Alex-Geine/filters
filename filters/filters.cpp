...
// filters.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CfiltersApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CfiltersApp

CfiltersApp::CfiltersApp()
{
...
// Единственный объект CfiltersApp

CfiltersApp theApp;


// Инициализация CfiltersApp

BOOL CfiltersApp::InitInstance()
{
